...
import com.capstone.pulih.databinding.DesignOnboardingBinding
...
class OnboardingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvSkip.setOnClickListener {
            Preferences().saveOnBoarding(true, requireContext())
...
class OnBoardingViewPager2Adapter : RecyclerView.Adapter<OnboardingDataPages>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OnboardingDataPages {
        return OnboardingDataPages(
            DesignOnboardingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
...
class OnboardingDataPages(val bindingDesign: DesignOnboardingBinding) : RecyclerView.ViewHolder(bindingDesign.root)
